...
#ifndef CUSTOM_COLMAP_SRC_UI_FEATURE_EXTRACTION_WIDGET_H_
#define CUSTOM_COLMAP_SRC_UI_FEATURE_EXTRACTION_WIDGET_H_
...
#endif  // CUSTOM_COLMAP_SRC_UI_FEATURE_EXTRACTION_WIDGET_H_
