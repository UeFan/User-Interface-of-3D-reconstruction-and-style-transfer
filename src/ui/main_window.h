...
#include "ui/custom_feature_extraction_widget.h"
...
class MainWindow : public QMainWindow {
 ...
 private:
  ...
  CustomWidget* custom_widget_;
  CustomWidget2* custom_widget2_;
  CustomWidget3* custom_widget3_;

  CustomFeatureExtractionWidget* custom_feature_extraction_widget_;
  CustomFeatureMatchingWidget* custom_feature_matching_widget_;
  ...
  QToolBar* custom_sdu_toolbar_;

  QDockWidget* dock_log_widget_;
  QDockWidget* dock_info_widget_;
  ...
  QAction* custom_action_1_;
  QAction* custom_action_2_;
  QAction* custom_action_3_;
