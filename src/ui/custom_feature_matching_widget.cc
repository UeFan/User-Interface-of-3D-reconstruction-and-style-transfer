...
#include "ui/custom_feature_matching_widget.h"



namespace colmap {

class CustomFeatureMatchingTab : public OptionsWidget {
 public:
  CustomFeatureMatchingTab(QWidget* parent, OptionManager* options);
...
class CustomExhaustiveMatchingTab : public CustomFeatureMatchingTab {
 public:
  CustomExhaustiveMatchingTab(QWidget* parent, OptionManager* options);
  void Run() override;

};

class CustomSequentialMatchingTab : public CustomFeatureMatchingTab {
 public:
  CustomSequentialMatchingTab(QWidget* parent, OptionManager* options);
  void Run() override;
};

class CustomVocabTreeMatchingTab : public CustomFeatureMatchingTab {
 public:
  CustomVocabTreeMatchingTab(QWidget* parent, OptionManager* options);
  void Run() override;
};

class CustomSpatialMatchingTab : public CustomFeatureMatchingTab {
 public:
  CustomSpatialMatchingTab(QWidget* parent, OptionManager* options);
  void Run() override;
};

class CustomTransitiveMatchingTab : public CustomFeatureMatchingTab {
 public:
  CustomTransitiveMatchingTab(QWidget* parent, OptionManager* options);
  void Run() override;
};

class CustomCustomMatchingTab : public CustomFeatureMatchingTab {
 public:
  CustomCustomMatchingTab(QWidget* parent, OptionManager* options);
  void Run() override;
...
CustomFeatureMatchingTab::CustomFeatureMatchingTab(QWidget* parent, OptionManager* options)
    : OptionsWidget(parent),
      options_(options),
      thread_control_widget_(new ThreadControlWidget(this)) {}

void CustomFeatureMatchingTab::CreateGeneralOptions() {
  AddSpacer();
  AddSpacer();
  ...
  connect(run_button, &QPushButton::released, this, &CustomFeatureMatchingTab::Run);
}

CustomExhaustiveMatchingTab::CustomExhaustiveMatchingTab(QWidget* parent,
                                             OptionManager* options)
    : CustomFeatureMatchingTab(parent, options) {
  AddOptionInt(&options_->exhaustive_matching->block_size, "block_size", 2);
  CreateGeneralOptions();
}

void CustomExhaustiveMatchingTab::Run() {
  WriteOptions();
...
CustomSequentialMatchingTab::CustomSequentialMatchingTab(QWidget* parent,
                                             OptionManager* options)
    : CustomFeatureMatchingTab(parent, options) {
...
void CustomSequentialMatchingTab::Run() {
  WriteOptions();
...
CustomVocabTreeMatchingTab::CustomVocabTreeMatchingTab(QWidget* parent,
                                           OptionManager* options)
    : CustomFeatureMatchingTab(parent, options) {
...
void CustomVocabTreeMatchingTab::Run() {
  WriteOptions();
...
CustomSpatialMatchingTab::CustomSpatialMatchingTab(QWidget* parent, OptionManager* options)
    : CustomFeatureMatchingTab(parent, options) {
...
void CustomSpatialMatchingTab::Run() {
  WriteOptions();
...
CustomTransitiveMatchingTab::CustomTransitiveMatchingTab(QWidget* parent,
                                             OptionManager* options)
    : CustomFeatureMatchingTab(parent, options) {
...
void CustomTransitiveMatchingTab::Run() {
  WriteOptions();
...
CustomCustomMatchingTab::CustomCustomMatchingTab(QWidget* parent, OptionManager* options)
    : CustomFeatureMatchingTab(parent, options) {
...
void CustomCustomMatchingTab::Run() {
  WriteOptions();
...
CustomFeatureMatchingWidget::CustomFeatureMatchingWidget(QWidget* parent,
                                             OptionManager* options)
    : parent_(parent) {
  ...
  tab_widget_->addTab(new CustomExhaustiveMatchingTab(this, options),
                      tr("Exhaustive"));
  tab_widget_->addTab(new CustomSequentialMatchingTab(this, options),
                      tr("Sequential"));
  tab_widget_->addTab(new CustomVocabTreeMatchingTab(this, options), tr("VocabTree"));
  tab_widget_->addTab(new CustomSpatialMatchingTab(this, options), tr("Spatial"));
  tab_widget_->addTab(new CustomTransitiveMatchingTab(this, options),
                      tr("Transitive"));
  tab_widget_->addTab(new CustomCustomMatchingTab(this, options), tr("Custom"));

  grid->addWidget(tab_widget_, 0, 0);
}

void CustomFeatureMatchingWidget::showEvent(QShowEvent* event) {
  parent_->setDisabled(true);
}

void CustomFeatureMatchingWidget::hideEvent(QHideEvent* event) {
  parent_->setEnabled(true);
}
  
void CustomFeatureMatchingWidget::CustomOneClick()
{
   static_cast<CustomFeatureMatchingTab*>(tab_widget_->currentWidget())->Run();
}
